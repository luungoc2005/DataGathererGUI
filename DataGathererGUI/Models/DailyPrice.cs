...
namespace DataGatherer.Models
{
    ...
    public class DailyPrice
    {
        ...
        private double _profit = double.NaN;
        private double _profitPositive = double.NaN;
        private double _profitNegative = double.NaN;
        ...
        public double Profit
        {
            get
            {
                if (_profit.Equals(double.NaN))
                {
                    _profit = (ClosePrice / PriorClosePrice) - 1;
                    if (_profit > 0) _profit = 1;
                    else if (_profit < 0) _profit = -1;
                    else _profit = 0;
                }
                return _profit;
            }
        ...
        [Label]
        public double ProfitPositive
        {
            get
            {
                if (_profitPositive.Equals(double.NaN)) _profitPositive = (Profit >= 0) ? 1.0 : 0.0;
                return _profitPositive;
            }
            set
            {
                _profitPositive = value;
            }
        }

        [Label]
        public double ProfitNegative
        {
            get
            {
                if (_profitNegative.Equals(double.NaN)) _profitNegative = (Profit < 0) ? 1.0 : 0.0;
                return _profitNegative;
            }
            set
            {
                _profitNegative = value;
            }
        }
